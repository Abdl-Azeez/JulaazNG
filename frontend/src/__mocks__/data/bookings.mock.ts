...
export const samplePropertyBookings: UIPropertyBooking[] = [
  ...
  },
  {
    ...
    timeline: [
      ...
      { status: 'under_review', timestamp: new Date('2024-01-27T09:00:00'), note: 'Application under review' },
    ],
  ...
  },
  {
    ...
    timeline: [
      ...
      { status: 'confirmed', timestamp: new Date('2024-02-12T09:00:00'), note: 'Booking confirmed' },
    ],
