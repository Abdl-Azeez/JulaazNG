...
export const mockAdminUsers: AdminUser[] = [
  {
    ...
    emailVerified: mockUsers.tenant1.emailVerified,
    phoneVerified: mockUsers.tenant1.phoneVerified,
  ...
  },
  {
    ...
    emailVerified: mockUsers.landlord1.emailVerified,
    phoneVerified: mockUsers.landlord1.phoneVerified,
